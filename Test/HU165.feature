Feature: API Validaciones TID y Merchant ID
  ...
  Scenario Outline: Captura exitosa de TID y MID en API V2 con diferentes longitudes
    ...
    And me dirijo a la web 
    And presiono en reportes 
    And coloco un rango de fecha actual 
    And deberia mostrarnos en el reporte los valores asignados y el item generado con exito //(esto revisarlo)
